...
class DataFeeder(threading.Thread):
    ...
    def __init__(self, hparams, file_list):
        ...
        for file in file_list:
            with open(file, encoding='utf-8') as f:
                crrt_metadata = [eval(line) for line in f]
        ...
        self.inputs, self.input_lengths, self.mel_targets, self.linear_targets, self.wavs = queue.dequeue()
    ...
    def _get_next_example(self):
        ...
        return (input_data, mel_target, linear_target, len(input_data))
